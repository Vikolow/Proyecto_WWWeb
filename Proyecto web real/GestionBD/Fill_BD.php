...
$sql_articulos = "
INSERT INTO Articulos (id, titulo, descripcion, contenido, id_usuario, id_categoria) VALUES
(0, 'Primer artículo de prueba', 
    'Este es un artículo generado para probar el ID = 0.', 
    'Contenido ficticio del artículo con ID 0. Aquí puedes agregar un texto representativo para realizar pruebas. Este artículo pertenece a la categoría de tecnología.', 
    2, 
    1),
(1, 'La revolución de la inteligencia artificial', 
    ...
    2, 
    1),
(2, 'Exploración espacial: el próximo paso', 
