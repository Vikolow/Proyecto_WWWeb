...
<?php
  ...
  if (isset($_REQUEST['Ingresar'])) {
    ...
    //La ejecutamos y dependiendo del resultado relizará una o otra acción
    if(mysqli_query($conn, $Request_Alta)){

      //en caso de que funcione la pagina nos redigirá a la pagina principal
      header("Location: MainPage.html");

    }else{

      //en caso de que no funcione muestra un mensaje, y reinicia la pagina para eliminar los valores.
      echo("azan putero falla login");
    }
      ...
      <h1 class="titulo">Registro</h1>
        ...
        <div class="wave-group">
          ...
          <input type="submit" class="registro" value="Registrarse" name="Ingresar" id="Ingresar">
            <br><br>
          <a href="MainPage.html" class="volver"> Volver</a>
    </form>
  </div>
    <?php
      }
